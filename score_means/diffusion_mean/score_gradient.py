...
class ScoreGradient(ABC):
    ...
    def grady(self, x:Array, y:Array, t:Array)->Array:
        ...
        return self.s1_model(x,y,t)#self.M.TM_proj(y, self.s1_model(x,y,t))
    ...
    def gradt(self, x:Array, y:Array, t:Array)->Array:
        ...
        if self.M.intrinsic:
            ...
            laplace_beltrami = jnp.trace(s2)+.5*jnp.dot(s1,jacfwd(lambda z: jnp.linalg.slogdet(self.M.G(z))[1])(self.M.invf(y)).squeeze())
        else:
